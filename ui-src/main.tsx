...
import { SafeComponent } from "../packages/classes/safe-component";
import { CheckListContent } from "../packages/constants/utils";
import { Button, Box, CircularProgress, FormControlLabel, Switch ,Tab, Tabs, ThemeProvider, Tooltip } from "@mui/material";
import { settings } from "../packages/constants/settings";
import { useState, Component } from "react";
import {theme as themeVars}from "../packages/constants/theme";
import { Wand } from "../icons/wand";
import { Loading } from "../packages/components/loading";
import {en, ru} from "../localize/i18n";
import { deepClone, fastClone } from "../packages/functions/fast-clone";
import traverse from "traverse";
import { BuilderElement } from "@builder.io/sdk";
import pako from "pako";
import * as amplitude from "../packages/functions/track";
import {v4 as uuid} from "uuid";
import { fileTypeFromBuffer } from "file-type";
import { transformWebpToPNG } from "../packages/functions/encode-images";
import { traverseLayers } from "../packages/functions/traverse-layers";
